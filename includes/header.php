    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (isLoggedIn()) : ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'senior_officer_tickets.php') ? 'active' : ''; ?>" href="senior_officer_tickets.php"><?php echo t('Contact Senior Officers'); ?></a>
                    </li>
                    <?php if (isAdmin()) : ?>
                        <li class="nav-item">
